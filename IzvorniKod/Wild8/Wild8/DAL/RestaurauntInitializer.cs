...
namespace Wild8.DAL
{
    public class RestaurauntInitializer : System.Data.Entity.DropCreateDatabaseAlways<RestaurauntContext>
    {
        ...
        private void generatePizzas(RestaurauntContext context)
        {
            ...
            {
                new Meal { Name = "Margharita", NumberOfOrders = 10, Description = "Rajčica, sir", Category = cat, ImagePath = "todo", IsAvailable = true },
                new Meal { Name = "Funghi", NumberOfOrders = 15, Description = "Rajčica, sir, šampinjoni", Category = cat, ImagePath = "todo", IsAvailable = true },
                new Meal { Name = "Vesuvio", NumberOfOrders = 20, Description = "Rajčica, sir, šunka", Category = cat, ImagePath = "todo", IsAvailable = true },
                new Meal { Name = "Capricciosa", NumberOfOrders = 40, Description = "Rajčica, sir, šunka, šampinjoni", Category = cat, ImagePath = "todo", IsAvailable = true },
                new Meal { Name = "Quattro formaggio", NumberOfOrders = 12, Description = "Rajčica, 4 vrste sira", Category = cat, ImagePath = "todo", IsAvailable = true },
                new Meal { Name = "Al tonno", NumberOfOrders = 9, Description = "Rajčica, sir, tunjevina", Category = cat, ImagePath = "todo", IsAvailable = true },
                ...
                new Meal { Name = "Vegetariana", NumberOfOrders = 30, Description = "Rajčica, sir, paprika, kukuruz, šampinjoni", Category = cat, ImagePath = "todo", IsAvailable = true },
                ...
                new Meal { Name = "Napolitana", NumberOfOrders = 5, Description = "Rajčica, sir, šunka, šampinjoni, špek, jaje", Category = cat, ImagePath = "todo", IsAvailable = true },
